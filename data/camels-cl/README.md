...
| catchment | objective | cal A → val B | cal B → val A |
|---|---|---|---|
| 8123001 | KGE | 0.833 → 0.794 | 0.847 → 0.761 |
| 8123001 | NSE | 0.691 → 0.643 | 0.709 → 0.655 |
| 7330001 | KGE | 0.866 → 0.819 | 0.868 → 0.823 |
| 7330001 | NSE | 0.740 → 0.741 | 0.744 → 0.735 |
